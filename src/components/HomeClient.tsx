    ...
    <main className="text-white overflow-x-hidden bg-transparent">
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <Link
            href="/blog"
            className="text-3xl font-bold mb-12 block hover:text-amber-500 transition"
          >
            LATEST POSTS ➔
          </Link>
          ...
          {posts?.slice(0, 5).map((post: any) => (
            <Link
              ...
              className="flex justify-between items-center py-6 border-b border-white/10 hover:bg-white/5 px-4 transition"
            >
